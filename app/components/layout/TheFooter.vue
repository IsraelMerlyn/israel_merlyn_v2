<template>
  <footer id="contacto" class="bg-navy-900 text-white pt-20 pb-10 relative overflow-hidden">
    ...
    <div class="max-w-7xl mx-auto px-6 relative z-10">
      <div class="flex flex-col md:flex-row justify-between items-center gap-8 mb-16 text-center md:text-left">
        
        <div class="max-w-xl">
          <h2 class="text-3xl md:text-5xl font-bold mb-6">
            ¿Listo para construir algo <span class="text-blue-400">increíble</span>?
          </h2>
