            ...
            <TransitionGroup name="list" tag="div" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <article v-for="project in filteredProjects" :key="project.id"
                 ...
                 class="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110" />
                  -->
                        <NuxtImg :src="project.image" :alt="project.title" format="webp" quality="80" loading="lazy"
                            class="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110" />
                        <div
                            class="absolute top-3 left-3 bg-white/90 backdrop-blur text-navy-900 text-xs font-bold px-2 py-1 rounded">
                    ...
                    <div class="p-6 flex flex-col flex-grow">
                        ...
                        <p class="text-slate-600 dark:text-slate-400 text-sm mb-4 flex-grow">{{ project.description }}
                        </p>
                        ...
                        <div
                            class="mt-auto pt-4 border-t border-slate-200 dark:border-navy-700 flex justify-between items-center">
                            <a href="#" class="text-blue-600 dark:text-blue-400 text-sm font-bold hover:underline">Ver
                                Proyecto -></a>
